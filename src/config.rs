...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("ZhenDesk".to_owned());
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "MyPassWord12345".to_string());
        RwLock::new(map)
    };
...
pub const RS_PUB_KEY: &str = "v+iUtH7YUrETIJJrgJZyLDgMh7Oc5HrtAPBpNJi5Vt8=";
